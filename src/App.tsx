  ...
  return (
    <LotProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="container mx-auto px-4 py-8 safe-area-inset">
...
function MenuButton({ title, description, onClick, bgColor, hoverColor }: MenuButtonProps) {
  return (
    <button
      onClick={onClick}
      className={`w-full ${bgColor} ${hoverColor} text-white rounded-xl shadow-xl overflow-hidden transition transform hover:scale-105 text-left p-6 touch-feedback`}
    >
